Не забудь установить зависимости: `npm i`<br>
Запуск jest: `npm test`<br>
Запуск testplain: `npx testplain` или `npx testplain gui`<br>
**Иногда testplane работает некорректно**

Выполнены все функциональные требования, кроме:
- вёрстка должна адаптироваться под ширину экрана

Пиши по вопросам и замечаниям: @AleBro9999<br>
